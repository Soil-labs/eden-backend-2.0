...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const subscriptionServer = new WebSocketServer({ server: httpServer, path: '/graphql', context: { text: "I am Context" } });
        ...
        const DATABASE_MONGO = process.env.REACT_APP_MONGO_DATABASE != undefined
            ? process.env.REACT_APP_MONGO_DATABASE
            : "graphQL_harveo";
        mongoose
            .connect(`mongodb+srv://milts10:O1eSaOUKmE1xXiEz@cluster0.tilvd.mongodb.net/${DATABASE_MONGO}?retryWrites=true&w=majority`, {
